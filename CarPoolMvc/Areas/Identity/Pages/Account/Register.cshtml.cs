...
namespace CarPoolMvc.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var addToRoleResult = await _userManager.AddToRoleAsync(user, "Passenger");
                    if (!addToRoleResult.Succeeded)
                    {
                        // Handle errors if adding role fails.
                        foreach (var error in addToRoleResult.Errors)
                        {
                            ModelState.AddModelError(string.Empty, error.Description);
                        }
                        // Return the page with the failure message.
                        return Page();
                    }
